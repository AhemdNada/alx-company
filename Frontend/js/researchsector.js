// Research Sector sliders & smooth scroll
(function(){
  ...
  attachSlider('rs1-slider','rs1-prev','rs1-next','rs1-dots');
  attachSlider('rs2-slider','rs2-prev','rs2-next','rs2-dots');
  attachSlider('rs3-slider','rs3-prev','rs3-next','rs3-dots');
  attachSlider('rs4-slider','rs4-prev','rs4-next','rs4-dots');
  attachSlider('rs5-slider','rs5-prev','rs5-next','rs5-dots');
  attachSlider('rs6-slider','rs6-prev','rs6-next','rs6-dots');

...
(function(){
  ...
  attachSlider('gc1-slider','gc1-prev','gc1-next','gc1-dots');
  attachSlider('gc2-slider','gc2-prev','gc2-next','gc2-dots');
  attachSlider('gc3-slider','gc3-prev','gc3-next','gc3-dots');
  attachSlider('gc4-slider','gc4-prev','gc4-next','gc4-dots');
  attachSlider('gc5-slider','gc5-prev','gc5-next','gc5-dots');
  attachSlider('gc6-slider','gc6-prev','gc6-next','gc6-dots');

  // Smooth scroll for in-page quick links (fallback if CSS not supported)
